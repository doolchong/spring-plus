...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoProjection>> searchTodoTitleList(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size,
        ...
        return ResponseEntity.ok(todoService.searchTodoTitleList(page, size, title, nickname, startedAt, endedAt));
    }
}
